  ...
  return (
    <div className="overflow-x-auto px-4 shadow-2xl rounded-lg bg-slate-200 backdrop-blur-md p-6 m-10">
      <table className="min-w-full text-sm rounded-lg py-4">
        <thead>
          <tr className="bg-blue-700 text-gray-100 rounded-lg shadow-xl">
              ...
              <td className="px-6 py-3">
                {editingContactId === contact.id ? (
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
                  />
                ) : (
                  contact.email
                )}
